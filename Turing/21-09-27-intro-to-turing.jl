...
# ╔═╡ 46dfac7c-af28-4c54-9fce-be4a5bb97799
using Random, Turing, Distributions, Plots, MCMCChains, StatsPlots

# ╔═╡ b580a470-1ec6-11ec-2239-4967f003e3d4
md"# Intro to Turing.jl
This is an introduction to `Turing.jl`.  Let's get started!
"

# ╔═╡ 3507deff-5772-4c39-8165-c065a192a982
# Set the true probability of heads in a coin.
p_true = 0.5

# ╔═╡ 694c3ef2-46a7-4807-b188-54e4c163457d
# Iterate from having seen 0 observations to 100 observations.
Ns = 0:100;

# ╔═╡ d8ad9951-c7ec-460f-be11-16e89f37e2b6
begin
...
# ╔═╡ 46c21151-7734-4e24-b62d-d044816bd008
data[1:5]

# ╔═╡ 83e44312-d614-4078-a0d9-2c298b7eeb04
prior_belief = Beta(1, 1);

# ╔═╡ 64d91c04-4fa2-4d0a-873f-99465f004aed
...
# ╔═╡ c7a0cf48-ceb8-4b5a-a93a-b97f894a0467
...
# ╔═╡ 6b513eab-c110-4844-8524-8bfe8ae21b4f
begin
...
# ╔═╡ 4e98d4b6-66d1-4397-9f47-4b47ea9d2d54
p_summary = chain[:p]

# ╔═╡ bc3f9403-f394-4719-8797-865644167715
...
# ╔═╡ e216af54-5554-450c-bcfd-897129f1688d
@assert isapprox(mean(p_summary), 0.5; atol=1)

# ╔═╡ ec1ded77-bea9-4803-97a0-e6c4d8df4b88
begin
...
# ╔═╡ 2e29bfd8-b817-451b-96ff-fd70a1277b0d
# p = plot(p_summary, seriestype = :density, xlim = (0,1), legend = :best, w = 2, c = :blue)

# ╔═╡ e406c6d4-e869-4e14-904d-a110cffaca11
# begin
